...
function Unsupported() {
  return (
    ...
    <div className="w-full lg:w-[40%] flex items-center flex-col">
      <p className="font-inter text-white text-[30px] font-[700] text-center">
        Leave the desktop mobile gaming rocks!
      </p>
      <div className="h-[300px] lg:h-[350px]  w-[80%] flex-col rounded-[10px] mt-[20%] flex items-center justify-center">
